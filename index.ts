    ...
    if (botMode === "insider") {
      ...
      return {
        text: [
          ...
          "6. Otherwise, watch the shared feePayer from the earliest bundler funding tx for transfer-outs >= largest bundler funding + 2 SOL.",
          "7. A transfer-out is only confirmed if the immediate next feePayer tx is not a SOL transfer-in.",
