    ...
    if (botMode === "insider") {
      ...
      return {
        text: [
          ...
          "4. Each bundler must have a valid first SOL funding transfer after its wallet was last 0 SOL, and all four funding txs must share the same feePayer.",
          "5. Watch the shared feePayer from the earliest bundler funding tx for transfer-outs >= largest bundler funding + 2 SOL.",
          "6. A transfer-out is only confirmed if the immediate next feePayer tx is not a SOL transfer-in.",
