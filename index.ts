  ...
  function homeReply(editCurrent = false): TelegramReply {
    ...
    return {
      text: [
        ...
        `3. Filters: mint ends <b>pump</b>, metadata URI <code>https://ipfs.io/ipfs/baf…</code>, dev created 0–1 tokens (Helius CREATE history; 0 requires valid first-four bundlers), migrate ≤ <b>${config.insiderFollowTokenMaxMigrationAgeSec}s</b> after create, dev funded by <b>Centralized Exchange</b>.`,
